						...
						handler : function(){
							...
							function loadListParamRegistro(form){
								storeEstudiante.load({
									params: {
										"estudiante.matricula":form.textoMatricula,
							...
							var gridEstudianteDuplicado=new Ext.grid.Panel({
							    ...
							    columns: [
									...
									{ text: 'Apellido Pate rno',  dataIndex: 'apellidoPaterno',flex:1 },
									...
									{ text: 'Procedencia de Maestrua',  dataIndex: 'procedenciaMaestria',flex:1, hidden: true},
									...
									{ text: 'Fech Registro',  dataIndex: 'actoFecha',flex:1, hidden: true},
							...
							var panelLoaderDuplicado= new Ext.panel.Panel({
								...
								items:[
									...
									{
										region: 'center',border: true,items : [gridEstudianteDuplicado]
									}
								]
							})
